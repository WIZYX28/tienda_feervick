          ...
          <div class="box-group" id="accordion">
            ...
            <div class="panel box box-info">
              ...
              <div class="box-header with-border">
                ...
                if (is_array($estiloImgProducto)) {
                  $estiloProducto = $estiloImgProducto;
                }
                ...
                <div class="btn-group pull-right">
                  ...
                  <button class="btn btn-primary guardarSlide"
                   ...
                   estiloImgProductoTop="'.$estiloProducto["top"].'"
                   estiloImgProductoRight="'.$estiloProducto["right"].'"
                   estiloImgProductoLeft="'.$estiloProducto["left"].'"
                   estiloImgProductoWidth="'.$estiloProducto["width"].'"
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" indice="'.$key.'" value="" class="slider form-control posVertical posVertical'.$key.'" data-slider-min="0" 
                          data-slider-max="50"
                          data-slider-step="5"
                          data-slider-value="'.$estiloProducto["top"].'" 
